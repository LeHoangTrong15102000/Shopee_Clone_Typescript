        ...
        <div className='container'>
          <div className='grid grid-cols-1 gap-6 md:grid-cols-12'>
            <div className='hidden md:block md:col-span-3'>
              <div className='bg-white rounded-sm p-4 animate-pulse'>
            ...
            <div className='col-span-1 md:col-span-9'>
              <div className='bg-white rounded-sm p-3 mb-6 animate-pulse'>
        ...
        <AnimatePresence>
          {isFetching && !isFetchingNextPage && (
            <motion.div
              ...
              exit={{ opacity: 0, x: 20 }}
              className='fixed top-20 right-4 z-50 bg-white shadow-lg rounded-lg p-3 border border-gray-200'
            >
            ...
            <div className='col-span-1 md:col-span-9'>
                  ...
                  >
                    ...
                    {isFetchingNextPage && Array(5).fill(0).map((_, index) => (
                      <motion.div key={`skeleton-${index}`} variants={itemVariants}>
                        <div className='flex bg-white rounded-lg shadow-sm overflow-hidden animate-pulse'>
                          <div className='w-32 h-32 sm:w-40 sm:h-40 md:w-48 md:h-48 flex-shrink-0 bg-gray-200' />
              ...
              <div className='mt-6 text-center'>
                ...
                {!hasNextPage && allProducts.length > 0 && (
                  <p className='text-gray-500 py-4'>Đã hiển thị tất cả {allProducts.length} sản phẩm</p>
                )}
              </div>
            </div>
          </div>
