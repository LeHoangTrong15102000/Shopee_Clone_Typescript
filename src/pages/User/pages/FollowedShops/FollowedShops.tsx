...
export default function FollowedShopsPage() {
  return (
    <div className='rounded-sm bg-white px-2 pb-10 shadow md:px-7 md:pb-20 dark:bg-slate-800'>
      <Helmet>
      ...
      <div className='border-b border-b-gray-200 py-6 dark:border-b-slate-600'>
        <h1 className='text-lg font-medium capitalize text-gray-900 dark:text-gray-100'>Shop đang theo dõi</h1>
