  ...
  if (compact) {
    return (
      <div className={`mt-4 px-2 ${className}`}>
        ...
        <div className='h-2 w-full rounded-full bg-gray-200 dark:bg-slate-700 overflow-hidden' role='progressbar' aria-valuenow={percentage} aria-valuemin={0} aria-valuemax={100} aria-label={`Tiến độ hoàn thành hồ sơ: ${percentage}%`}>
          <motion.div
    ...
    <div className={`relative mt-6 overflow-hidden rounded-2xl bg-white dark:bg-slate-800 shadow-lg ${className}`}>
        ...
        <div className='relative flex items-center justify-between'>
          <div>
            ...
            <p className='mt-1 text-sm text-white/80'>
              {percentage === 100 ? 'Tuyệt vời! Hồ sơ đã hoàn chỉnh' : `Còn ${incompleteFields.length} mục cần cập nhật`}
            </p>
          </div>
          {percentage === 100 && (
            <motion.div
      ...
      <div className='p-6'>
        <div className='flex flex-col sm:flex-row items-center gap-8'>
          ...
          <div className='relative flex-shrink-0' role='progressbar' aria-valuenow={percentage} aria-valuemin={0} aria-valuemax={100} aria-label={`Tiến độ hoàn thành hồ sơ: ${percentage}%`}>
            ...
            <div className='absolute inset-0 flex flex-col items-center justify-center p-4' aria-hidden='true'>
              ...
              <span className='text-[10px] font-medium mt-0.5' style={{ color: statusColor.from, opacity: 0.75 }}>hoàn thành</span>
            </div>
          </div>
                ...
                return (
                  ...
                  >
                    ...
                    {isComplete ? (
                      ...
                      >
                        <svg className='h-3.5 w-3.5 text-white drop-shadow-sm' fill='none' viewBox='0 0 24 24' stroke='currentColor' strokeWidth={3} aria-hidden='true'>
                      ...
                      >
                        ...
                        <svg className='relative z-10 h-3 w-3 transition-transform group-hover:translate-x-0.5' fill='none' viewBox='0 0 24 24' stroke='currentColor' strokeWidth={2.5}>
          ...
          {percentage < 100 && (
            ...
            >
              <h4 className='text-xs font-bold text-gray-500 dark:text-gray-400 uppercase tracking-wider'>Lợi ích khi hoàn thành</h4>
              {[
                {
                  id: 'security',
                  icon: (
          ...
          {percentage === 100 && (
            ...
            >
              ...
              <div className='text-center'>
                ...
                <p className='text-[11px] text-amber-600/80 dark:text-amber-400/80 mt-1 leading-relaxed'>Hồ sơ hoàn chỉnh giúp bạn nhận được nhiều ưu đãi hơn</p>
              </div>
        ...
        {percentage < 100 && (
          ...
          >
            ...
            <div className='flex-1'>
              ...
              <p className='text-xs text-blue-600/80 dark:text-blue-300/80 mt-0.5'>Hoàn thành hồ sơ để nhận ưu đãi và bảo mật tài khoản tốt hơn!</p>
            </div>
            <Link
              to={path.profile}
