...
import { PurchaseStatus } from '../../types/purchases.type'
...
const Header = () => {
  ...
  const queryConfig = useQueryConfig() // lấy ra queryConfig để khi search truyền searchParams và lọc params không cần thiết
