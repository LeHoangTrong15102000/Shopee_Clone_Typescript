...
const ORDER_STEPS: OrderStep[] = [
  { status: purchasesStatus.waitForConfirmation, label: 'Chờ xác nhận', icon: 'clock', description: 'Đơn hàng đang chờ người bán xác nhận' },
  { status: purchasesStatus.waitForGetting, label: 'Chờ lấy hàng', icon: 'package', description: 'Người bán đang chuẩn bị hàng' },
  { status: purchasesStatus.inProgress, label: 'Đang giao', icon: 'truck', description: 'Đơn hàng đang được vận chuyển' },
      ...
      <div className={classNames('relative', className)}>
        ...
        >
          ...
          <div>
            ...
            <p className='mt-1 text-sm text-red-500/80 dark:text-red-400/70'>Đơn hàng này đã bị hủy bởi người bán hoặc người mua</p>
          </div>
        </motion.div>
      </div>
    )
