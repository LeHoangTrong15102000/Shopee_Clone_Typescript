...
const CartHeader = ({ title = 'giỏ hàng' }: CartHeaderProps) => {
  ...
  return (
    ...
    >
      <div className='hidden md:block bg-orange text-white'>
        <div className='container'>
          <NavHeader />
        </div>
      </div>
      <div className='h-auto min-h-[4rem] md:h-[6.25rem] border-b border-b-[rgba(0,0,0,.09)] dark:border-b-slate-700 bg-white dark:bg-slate-800 py-3 md:py-6'>
        <div className='container'>
          <nav className='flex items-center gap-2 sm:gap-4 md:gap-6 md:justify-between'>
            {/* Đường dẫn về trang chủ shopee, Logo shopee và tiêu đề mua hàng*/}
            <Link to={path.home} className='flex flex-shrink-0 items-end'>
              <div>
                <svg viewBox='0 0 192 65' className='h-7 fill-orange dark:fill-orange-400 sm:h-8 md:h-11'>
                  <g fillRule='evenodd'>
              ...
              <div className='mx-2 h-5 border-r-[1px] border-r-orange dark:border-r-orange-400 sm:mx-4 sm:h-6 md:h-8'></div>
              <motion.div
                className='text-sm font-normal capitalize text-orange dark:text-orange-400 sm:text-[15px] md:text-2xl'
            ...
            <motion.form
              className='flex-1 min-w-0 md:flex-none md:w-[50%]'
              onSubmit={onSubmitSearch}
              initial={{ opacity: 0, x: 20 }}
              animate={{ opacity: 1, x: 0 }}
              transition={{ duration: 0.3, delay: 0.3 }}
            >
              <div className='flex rounded-sm border-2 border-orange dark:border-orange-400'>
                <input
                  type='text'
                  className='w-full flex-grow border-none bg-transparent px-2 py-2 text-xs md:px-3 md:text-sm text-[rgba(0,0,0,.95)] dark:text-gray-100 outline-none'
                  placeholder='Đăng ký và nhận voucher bạn mới đến 70k!'
                  {...register('name')}
                />
                <motion.button
                  type='submit'
                  className='flex-shrink-0 rounded-sm bg-[linear-gradient(-180deg,#f53d2d,#f63)] py-2 px-4 sm:py-2 sm:px-5 md:px-8 hover:opacity-90'
            ...
            <button
              ...
              className='flex-shrink-0 p-1 text-orange dark:text-orange-400 hover:text-orange/70 md:hidden'
